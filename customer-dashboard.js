...
async function markBuyingItemPosted(id){
 try{await api('/rest/v1/rpc/customer_mark_buying_item_posted',{method:'POST',body:JSON.stringify({p_tenant_id:tenantId,p_acquisition_id:id})});setMessage('Your item has been marked as posted.','success');await loadPortalData()}catch(e){setMessage(e.message||String(e),'error')}
}
