...
let retailListings=[];
let themeColors={accent:'#c46a2b',page_bg:'#f5f6f8',text:'#17202a',header_bg:'#ffffff',buy_bg:'#ffffff',sell_bg:'#f4f6f7',footer_bg:'#17202a',background_id:'clean-wave'};
const websiteBackgrounds=[{"id":"music","label":"Music Notes","color":"#fbf7f0","image":"radial-gradient(circle at 18px 18px,#8d6f58 0 2px,transparent 3px),linear-gradient(70deg,transparent 47%,#8d6f58 48% 50%,transparent 51%)","size":"70px 70px","repeat":"repeat"},{"id":"camera","label":"Cameras & Accessories","color":"#f0f3f4","image":"radial-gradient(circle at 55px 55px,#64727b 0 14px,transparent 15px),linear-gradient(#64727b,#64727b) 28px 35px/54px 8px no-repeat","size":"110px 110px","repeat":"repeat"},{"id":"mobile","label":"Mobile Phones & Tech","color":"#eef5fc","image":"linear-gradient(#5a82a6,#5a82a6) 22px 18px/42px 76px no-repeat,radial-gradient(circle at 43px 82px,#5a82a6 0 2px,transparent 3px)","size":"90px 100px","repeat":"repeat"},{"id":"instruments","label":"Musical Instruments","color":"#fbf3e8","image":"radial-gradient(ellipse at 55px 70px,#9c7756 0 20px,transparent 21px),linear-gradient(90deg,transparent 0 53px,#9c7756 54px 58px,transparent 59px)","size":"120px 120px","repeat":"repeat"},{"id":"drone","label":"Drones & RC","color":"#eef6fb","image":"radial-gradient(circle at 22px 22px,#5b86aa 0 11px,transparent 12px),radial-gradient(circle at 98px 22px,#5b86aa 0 11px,transparent 12px),radial-gradient(circle at 22px 98px,#5b86aa 0 11px,transparent 12px),radial-gradient(circle at 98px 98px,#5b86aa 0 11px,transparent 12px)","size":"120px 120px","repeat":"repeat"},{"id":"tools","label":"Tools & Hardware","color":"#f0f2f3","image":"linear-gradient(45deg,transparent 43%,#6c767d 44% 48%,transparent 49%),linear-gradient(-45deg,transparent 43%,#6c767d 44% 48%,transparent 49%)","size":"90px 90px","repeat":"repeat"},{"id":"vehicles","label":"Vehicles & Automotive","color":"#f5f0e8","image":"radial-gradient(circle at 28px 65px,#8c765e 0 10px,transparent 11px),radial-gradient(circle at 92px 65px,#8c765e 0 10px,transparent 11px),linear-gradient(#8c765e,#8c765e) 18px 42px/85px 28px no-repeat","size":"120px 100px","repeat":"repeat"},{"id":"home","label":"Home & Living","color":"#f6f3ed","image":"linear-gradient(135deg,transparent 34%,#8d806e 35% 38%,transparent 39%),linear-gradient(#8d806e,#8d806e) 32px 55px/38px 35px no-repeat","size":"110px 100px","repeat":"repeat"},{"id":"kitchen","label":"Kitchen & Appliances","color":"#f3f3ef","image":"radial-gradient(ellipse at 52px 65px,#777873 0 18px,transparent 19px),linear-gradient(#777873,#777873) 35px 48px/34px 5px no-repeat","size":"110px 100px","repeat":"repeat"},{"id":"fashion","label":"Fashion & Accessories","color":"#f8f1ee","image":"radial-gradient(ellipse at 55px 58px,#9c806e 0 18px,transparent 19px),linear-gradient(90deg,#9c806e 0 4px,transparent 5px) 48px 30px/15px 65px no-repeat","size":"110px 100px","repeat":"repeat"},{"id":"office","label":"Office & Business","color":"#eff4f7","image":"linear-gradient(#637789,#637789) 22px 22px/66px 48px no-repeat,linear-gradient(#637789,#637789) 30px 78px/50px 3px no-repeat","size":"110px 110px","repeat":"repeat"},{"id":"toys","label":"Toys","color":"#fff3e9","image":"linear-gradient(#b77e5d,#b77e5d) 22px 50px/35px 35px no-repeat,linear-gradient(#e1a55f,#e1a55f) 58px 28px/35px 35px no-repeat,radial-gradient(circle at 30px 35px,#b77e5d 0 10px,transparent 11px)","size":"115px 105px","repeat":"repeat"},{"id":"gaming","label":"Gaming","color":"#eef0fb","image":"linear-gradient(135deg,transparent 30%,#6874a6 31% 33%,transparent 34%),radial-gradient(circle at 42px 57px,#6874a6 0 4px,transparent 5px)","size":"120px 100px","repeat":"repeat"},{"id":"clean-wave","label":"Clean Wave","color":"#f5faff","image":"linear-gradient(155deg,transparent 35%,rgba(100,170,220,.16) 36% 40%,transparent 41%),linear-gradient(25deg,transparent 52%,rgba(100,170,220,.11) 53% 57%,transparent 58%)","size":"cover","repeat":"no-repeat"},{"id":"pastel-gradient","label":"Pastel Gradient","color":"#fff4f7","image":"linear-gradient(135deg,#ffe5ee 0%,#e5f2ff 48%,#eee5ff 100%)","size":"cover","repeat":"no-repeat"},{"id":"blue-wave","label":"Blue Wave","color":"#eaf5ff","image":"linear-gradient(150deg,#d7ebfa,#a9d2f1 45%,#edf7ff 75%,#c7e2f6)","size":"cover","repeat":"no-repeat"},{"id":"green-wave","label":"Green Wave","color":"#eef9f2","image":"linear-gradient(150deg,#dff4e6,#bde4ca 45%,#f4fbf6 75%,#d2ecda)","size":"cover","repeat":"no-repeat"},{"id":"warm-wave","label":"Warm Wave","color":"#fff8ee","image":"linear-gradient(150deg,#fff0d9,#f2c796 45%,#fffaf3 75%,#f6dfc2)","size":"cover","repeat":"no-repeat"},{"id":"purple-wave","label":"Purple Wave","color":"#f8f2ff","image":"linear-gradient(150deg,#eee1ff,#d2bde9 45%,#faf6ff 75%,#e6d5f5)","size":"cover","repeat":"no-repeat"},{"id":"dark-wave","label":"Dark Wave","color":"#0e1722","image":"linear-gradient(150deg,#0c1622,#234766 48%,#0b1119)","size":"cover","repeat":"no-repeat"},{"id":"hexagon","label":"Hexagon Pattern","color":"#f7f8f9","image":"linear-gradient(30deg,#e4e8eb 12%,transparent 12.5%,transparent 87%,#e4e8eb 87.5%),linear-gradient(150deg,#e4e8eb 12%,transparent 12.5%,transparent 87%,#e4e8eb 87.5%)","size":"40px 70px","repeat":"repeat"},{"id":"dot","label":"Dot Pattern","color":"#fafbfc","image":"radial-gradient(circle,#b7c0c7 1.5px,transparent 1.6px)","size":"18px 18px","repeat":"repeat"},{"id":"stripes","label":"Diagonal Stripes","color":"#f4f6f7","image":"repeating-linear-gradient(135deg,#f4f6f7 0,#f4f6f7 12px,#e5e9ec 12px,#e5e9ec 24px)","size":"auto","repeat":"repeat"},{"id":"bokeh","label":"Soft Bokeh","color":"#f7f4ef","image":"radial-gradient(circle at 20% 25%,rgba(255,255,255,.9) 0 7%,transparent 8%),radial-gradient(circle at 72% 62%,rgba(255,255,255,.8) 0 9%,transparent 10%),linear-gradient(135deg,#f6efe7,#eef3f7)","size":"cover","repeat":"no-repeat"},{"id":"marble","label":"Marble","color":"#f7f7f7","image":"linear-gradient(115deg,transparent 0 40%,rgba(100,110,120,.09) 41%,transparent 42%),linear-gradient(25deg,#fafafa,#e8eaec,#fff)","size":"320px 320px","repeat":"repeat"},{"id":"watercolour","label":"Watercolour","color":"#fafafa","image":"radial-gradient(circle at 25% 25%,rgba(244,170,170,.24),transparent 28%),radial-gradient(circle at 75% 35%,rgba(160,200,245,.27),transparent 32%),radial-gradient(circle at 55% 75%,rgba(170,225,190,.22),transparent 30%)","size":"cover","repeat":"no-repeat"},{"id":"abstract","label":"Abstract Shapes","color":"#f6f4ee","image":"radial-gradient(ellipse at 15% 25%,#dce8ef 0 12%,transparent 13%),radial-gradient(ellipse at 78% 28%,#f2dfd2 0 15%,transparent 16%),radial-gradient(ellipse at 48% 78%,#dce8d9 0 18%,transparent 19%)","size":"cover","repeat":"no-repeat"},{"id":"soft-texture","label":"Soft Texture","color":"#f6f2eb","image":"radial-gradient(circle,rgba(110,100,90,.08) 0 1px,transparent 2px),linear-gradient(120deg,rgba(255,255,255,.65),rgba(232,226,216,.55))","size":"28px 28px","repeat":"repeat"},{"id":"dark-geometry","label":"Dark Geometry","color":"#11151b","image":"linear-gradient(135deg,#11151b 25%,#1d242c 25% 50%,#11151b 50% 75%,#252e38 75%)","size":"80px 80px","repeat":"repeat"},{"id":"colour-blend","label":"Colour Blend","color":"#f8e2eb","image":"linear-gradient(135deg,#f8dce8,#dcecff 48%,#e8ddfb)","size":"cover","repeat":"no-repeat"}];
function applyWebsiteBackground(){const p=websiteBackgrounds.find(x=>x.id===themeColors.background_id)||websiteBackgrounds[13];const e=$('site-editor');if(!e)return;e.style.setProperty('--site-background-color',p.color);e.style.setProperty('--site-background-image',p.image);e.style.setProperty('--site-background-size',p.size);e.style.setProperty('--site-background-repeat',p.repeat);}
function selectWebsiteBackground(id){const p=websiteBackgrounds.find(x=>x.id===id);if(!p)return;themeColors.background_id=p.id;applyWebsiteBackground();document.querySelectorAll('[data-background]').forEach(b=>b.classList.toggle('selected',b.dataset.background===p.id));renderEditor();markDirty();setStatus(p.label+' background selected. Save the draft to keep the change.','success');}
...
function renderDesignControls(){
 ...
 box.innerHTML='<div class="control-title">Website background</div><small>Choose a specialist category pattern or a neutral background. It can be changed independently of the colour palette.</small><div class="background-grid">'+websiteBackgrounds.map(p=>'<button type="button" class="background-option '+(themeColors.background_id===p.id?'selected':'')+'" data-background="'+p.id+'" title="'+esc(p.label)+'"><span style="background-color:'+p.color+';background-image:'+p.image+';background-size:'+p.size+';background-repeat:'+p.repeat+'"></span><b>'+esc(p.label)+'</b></button>').join('')+'</div><div class="control-title">Brand colours</div><small>Change the main colours of your customer-facing website. The selected design still controls layout and typography.</small><div class="color-grid">'+colors.map(([key,label])=>'<label class="color-control"><span>'+label+'</span><input type="color" data-color="'+key+'" value="'+esc(themeColors[key])+'"><code>'+esc(themeColors[key])+'</code></label>').join('')+'</div><div class="preset-row"><span>Quick palettes</span><small>Choose a coordinated starting palette, then fine-tune any colour above.</small>'+Object.entries(palettes).map(([id,p])=>'<button type="button" data-palette="'+id+'" title="'+esc(p.label+' — '+p.description)+'"><i style="background:'+p.accent+'"></i>'+esc(p.label)+'</button>').join('')+'</div>';
 box.querySelectorAll('[data-background]').forEach(b=>{b.addEventListener('click',e=>{e.preventDefault();e.stopPropagation();selectWebsiteBackground(b.dataset.background);});b.addEventListener('pointerup',e=>e.stopPropagation());});
...
function buildContent(){
 return {schema_version:2,template_reset_version:2,site:{
   ...
   pages:pages,
   theme:{accent:themeColors.accent||accent||'#c46a2b',page_bg:themeColors.page_bg,text:themeColors.text,header_bg:themeColors.header_bg,buy_bg:themeColors.buy_bg,sell_bg:themeColors.sell_bg,footer_bg:themeColors.footer_bg,background_id:themeColors.background_id||'clean-wave',background_color:websiteBackgrounds.find(x=>x.id===themeColors.background_id)?.color||'#f5faff',background_image:websiteBackgrounds.find(x=>x.id===themeColors.background_id)?.image||'',background_size:websiteBackgrounds.find(x=>x.id===themeColors.background_id)?.size||'cover',background_repeat:websiteBackgrounds.find(x=>x.id===themeColors.background_id)?.repeat||'no-repeat',typography:typography},
   social:socialLinks,
...
function loadContent(content){
 ...
 themeColors={accent:accent,page_bg:s.theme?.page_bg||'#f5f6f8',text:s.theme?.text||'#17202a',header_bg:s.theme?.header_bg||'#ffffff',buy_bg:s.theme?.buy_bg||'#ffffff',sell_bg:s.theme?.sell_bg||'#f4f6f7',footer_bg:s.theme?.footer_bg||'#17202a',background_id:s.theme?.background_id||'clean-wave'};
...
function resetToFreshWebsite(){
 ...
 homepageTiles=defaultHomepageTiles();themeColors={accent:'#c46a2b',page_bg:'#f5f6f8',text:'#17202a',header_bg:'#ffffff',buy_bg:'#ffffff',sell_bg:'#f4f6f7',footer_bg:'#17202a',background_id:'clean-wave'};
