...
- The customer portal had two independent authentication controllers bound to the same Sign in/Create customer account controls: `customer-auth.js` and `customer-dashboard.js`.
