...
const tradeflowReferrer=new URL(document.referrer||location.href);
const tradeflowListingId=tradeflowParams.get('listing_id')||tradeflowReferrer.searchParams.get('listing')||tradeflowReferrer.searchParams.get('listing_id');
if(tradeflowListingId){const tradeflowTenantId=tradeflowParams.get('tenant_id')||tradeflowReferrer.searchParams.get('tenant_id')||localStorage.getItem('tradeflow_customer_tenant_id')||'';if(tradeflowTenantId)localStorage.setItem('tradeflow_customer_tenant_id',tradeflowTenantId);window.location.href='customer-checkout.html?tenant_id='+encodeURIComponent(tradeflowTenantId)+'&listing_id='+encodeURIComponent(tradeflowListingId)+'&checkout_v=5';}
