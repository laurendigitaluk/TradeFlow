...
async function openShip(id,kind){
 ...
 try{
  ...
  popup.document.write('<!doctype html><html><head><title>Shipping '+(kind==='label'?'Label':'QR Code')+'</title><style>'+
   ...
   '.page img,.page iframe{display:block;width:4in;height:6in;max-width:6in;max-height:4in;border:0;object-fit:contain;background:#fff}'+
