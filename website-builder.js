...
const websiteBackgrounds=[
 {id:'clean-wave',label:'Clean Wave',color:'#f5f8fb',image:'linear-gradient(135deg,#f5f8fb 0%,#e7eef5 48%,#ffffff 100%)',size:'cover',repeat:'no-repeat'},
 {id:'soft-blue',label:'Soft Blue',color:'#eaf3fb',image:'linear-gradient(135deg,#eaf3fb 0%,#d6e8f7 52%,#f8fbff 100%)',size:'cover',repeat:'no-repeat'},
 {id:'soft-green',label:'Soft Green',color:'#edf7f0',image:'linear-gradient(135deg,#edf7f0 0%,#dcefe2 52%,#fbfdfb 100%)',size:'cover',repeat:'no-repeat'},
 {id:'warm-sand',label:'Warm Sand',color:'#f7f1e8',image:'linear-gradient(135deg,#f7f1e8 0%,#eadfce 52%,#fffaf4 100%)',size:'cover',repeat:'no-repeat'},
 {id:'soft-lavender',label:'Soft Lavender',color:'#f3effa',image:'linear-gradient(135deg,#f3effa 0%,#e4dcf3 52%,#fbf9ff 100%)',size:'cover',repeat:'no-repeat'},
 {id:'sunset',label:'Sunset',color:'#fff0e8',image:'linear-gradient(135deg,#fff0e8 0%,#f5d5c4 48%,#eadcf4 100%)',size:'cover',repeat:'no-repeat'},
 {id:'fine-diagonal',label:'Fine Diagonal',color:'#f3f5f7',image:'repeating-linear-gradient(135deg,rgba(60,75,90,.08) 0 1px,transparent 1px 12px)',size:'auto',repeat:'repeat'},
 {id:'wide-diagonal',label:'Wide Diagonal',color:'#f1f3f5',image:'repeating-linear-gradient(135deg,rgba(60,75,90,.10) 0 7px,transparent 7px 24px)',size:'auto',repeat:'repeat'},
 {id:'soft-dots',label:'Soft Dots',color:'#f7f8fa',image:'radial-gradient(circle,rgba(60,75,90,.13) 0 2px,transparent 2.5px)',size:'22px 22px',repeat:'repeat'},
 {id:'fine-grid',label:'Fine Grid',color:'#f5f7f9',image:'linear-gradient(rgba(60,75,90,.07) 1px,transparent 1px),linear-gradient(90deg,rgba(60,75,90,.07) 1px,transparent 1px)',size:'28px 28px',repeat:'repeat'},
 {id:'soft-hex',label:'Soft Hex',color:'#f2f5f7',image:'linear-gradient(30deg,rgba(70,90,105,.07) 12%,transparent 12.5%,transparent 87%,rgba(70,90,105,.07) 87.5%,rgba(70,90,105,.07)),linear-gradient(150deg,rgba(70,90,105,.07) 12%,transparent 12.5%,transparent 87%,rgba(70,90,105,.07) 87.5%,rgba(70,90,105,.07)),linear-gradient(30deg,rgba(70,90,105,.07) 12%,transparent 12.5%,transparent 87%,rgba(70,90,105,.07) 87.5%,rgba(70,90,105,.07)),linear-gradient(150deg,rgba(70,90,105,.07) 12%,transparent 12.5%,transparent 87%,rgba(70,90,105,.07) 87.5%,rgba(70,90,105,.07)),linear-gradient(60deg,rgba(70,90,105,.07) 25%,transparent 25.5%,transparent 75%,rgba(70,90,105,.07) 75%)',size:'56px 96px',repeat:'repeat'},
 {id:'dark-geometry',label:'Dark Geometry',color:'#111820',image:'linear-gradient(135deg,#111820 25%,#1b2530 25% 50%,#111820 50% 75%,#26323e 75%)',size:'80px 80px',repeat:'repeat'}
];
