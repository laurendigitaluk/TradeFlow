...
function renderSellingStatus(data,offers,acquisitions,shipping){
 ...
 const active=acq?.status==='awaiting_item'?{...base,stage:'awaiting_item',message:'Your shipping label and instructions have been sent. Arrange and pay for your shipping, then send the item.'}:base;
 const cls=active.stage==='manual_valuation'?'manual':active.stage==='offer_ready'?'ready':active.stage==='offer_accepted'?'accepted':active.stage==='awaiting_item'?'progress':'progress';
 const title=active.stage==='manual_valuation'?'Manual valuation required':active.stage==='offer_ready'?'Manual offer sent — awaiting your response':active.stage==='offer_accepted'?'Offer accepted — awaiting shipping label':active.stage==='awaiting_item'?'Awaiting item from you — shipping instructions sent':active.stage==='valued'?'Valuation completed':'Valuation in progress';
