...
const websiteBackgrounds=[
 ...
 {id:'fine-diagonal',label:'Fine Lines',color:'#f4f6f8',image:'repeating-linear-gradient(135deg,color-mix(in srgb,var(--accent) 32%,transparent) 0 2px,transparent 2px 12px)',size:'auto',repeat:'repeat'},
 {id:'wide-diagonal',label:'Wide Lines',color:'#f2f4f6',image:'repeating-linear-gradient(135deg,color-mix(in srgb,var(--accent) 42%,transparent) 0 8px,transparent 8px 26px)',size:'auto',repeat:'repeat'},
 {id:'soft-dots',label:'Dot Pattern',color:'#f6f7f9',image:'radial-gradient(circle,color-mix(in srgb,var(--accent) 38%,transparent) 0 2.5px,transparent 3px)',size:'22px 22px',repeat:'repeat'},
 {id:'fine-grid',label:'Grid Pattern',color:'#f4f6f8',image:'linear-gradient(color-mix(in srgb,var(--accent) 25%,transparent) 1.5px,transparent 1.5px),linear-gradient(90deg,color-mix(in srgb,var(--accent) 25%,transparent) 1.5px,transparent 1.5px)',size:'28px 28px',repeat:'repeat'},
 {id:'soft-hex',label:'Hex Pattern',color:'#f2f5f7',image:'linear-gradient(30deg,color-mix(in srgb,var(--accent) 25%,transparent) 12%,transparent 12.5%,transparent 87%,color-mix(in srgb,var(--accent) 25%,transparent) 87.5%),linear-gradient(150deg,color-mix(in srgb,var(--accent) 25%,transparent) 12%,transparent 12.5%,transparent 87%,color-mix(in srgb,var(--accent) 25%,transparent) 87.5%),linear-gradient(60deg,color-mix(in srgb,var(--accent) 18%,transparent) 25%,transparent 25.5%,transparent 75%,color-mix(in srgb,var(--accent) 18%,transparent) 75%)',size:'56px 96px',repeat:'repeat'},
